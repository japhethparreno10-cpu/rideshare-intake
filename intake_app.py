...
def render():
    ...
    # ========= EXPORT (XLSX with formatting + optional CSV)
    st.subheader("Export")

    # Build export payload dict (ensure no unterminated strings)
    export_payload = {
        # Caller
    ...
    # ---- Download Excel (formatted, centered + wrap)
    ...
    # ---- Optional legacy CSV (no formatting)
    st.download_button(
        "Download CSV (legacy)",
